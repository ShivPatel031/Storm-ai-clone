import arxivImg from "../../assets/arXiv_logo.fd5e317c.svg";
...
function WLHomeBody() {
  const { mode } = useContext(SelectedMode);
  return (
    <div className="flex items-center justify-center h-full">
      <div className="w-full h-[calc(90vh-0.5rem)] flex justify-center items-center flex-col px-10">
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-full max-w-2xl flex flex-col">
            <SearchArea />
            <div className="flex md:flex-row space-x-3 mt-4 overflow-scroll md:overflow-visible no-scrollbar">
              {example &&
                example.map((content) => (
            ...
            <div className="flex flex-row justify-center mt-4 space-x-4">
              ...
              >
                ...
                >
                  ...
                  />
                  {mode === "storm" ? "arXiv (STORM)" : "arXiv (CO-STORM)"}
                </a>
              </div>
              <div
                className="text-center"
